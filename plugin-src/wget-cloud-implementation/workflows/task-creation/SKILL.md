...
Не реализуй application code. Найди однозначный GitHub Project, проверь существующие issues/items на дубли. Mutation только по явно запрошенному exact MutationPlan, затем read-after-write. Product semantics не выдумывай. Test policy остаётся provisional.
