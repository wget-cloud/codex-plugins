...
2. Release identity: service, commit, binary build и image digest/tag.
3. gRPC/HTTP response, redacted logs/metrics/traces или CI row evidence без credentials и payload/PII.
