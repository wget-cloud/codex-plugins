...
Conditional gates добавляются по route flags: `security-reviewer: approved`, `contract-qa: pass`, `devops: prepared`, `infrastructure-reviewer: approved`, `deployment-agent: deployed_healthy`.
