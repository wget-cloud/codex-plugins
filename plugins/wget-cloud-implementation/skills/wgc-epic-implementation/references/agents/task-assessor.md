...
TaskAssessment по [контракту](../task-assessment.md). Verdict: `assessed | needs_evidence | needs_input`. Отдельный запуск на задачу, в epic на item. Неопределённость требует limited evidence, а не Light или фиктивный успех.
